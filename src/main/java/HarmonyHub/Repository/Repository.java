...
import HarmonyHub.Validators.ValidationException;
 ...
 *
 * @param <ID> Type E has an attribute of type ID
 * @param <E>  type of etities saved in repository
 */
public interface Repository<ID, E extends Entity<ID>> {
    ...
    /**
     * @param entity
     * entity must not be null* @return an {@code Optional}
